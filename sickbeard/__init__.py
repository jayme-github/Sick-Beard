...
from providers import ezrss, tvtorrents, btn, nzbmatrix, nzbsrus, newznab, womble, newzbin, nzbs_org_old, nzbindex, kere_ws
...
USE_LISTVIEW = None
ETADATA_XBMC = None
ETADATA_MEDIABROWSER = None
ETADATA_PS3 = None
ETADATA_WDTV = None
ETADATA_TIVO = None
ETADATA_SYNOLOGY = None
